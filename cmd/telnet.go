...
var telnetCmd = &cobra.Command{
	Use:   "telnet",
	Short: "Telnet load generator",
	Long:  ``,
	Args: func(cmd *cobra.Command, args []string) error {
		if len(args) < 1 {
			return errors.New("telnet requires host:port")
		}
		return nil
	},
	Run: func(cmd *cobra.Command, args []string) {
		plan := defaultPlan("telnet")
...
func init() {
	...
	telnetCmd.PersistentFlags().AddFlagSet(planFlags())
	telnetCmd.AddCommand(newDocCmd())
}
